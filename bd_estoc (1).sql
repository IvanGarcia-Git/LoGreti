...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2020 a las 19:45:22
...
CREATE TABLE `tbl_usuario` (
  ...
  `nombre_usuario` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `password_usuario` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
